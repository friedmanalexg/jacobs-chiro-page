...
const Services = () => {
      ...
      <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div class="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-2">
          <a
            ...
            href="https://www.spine-health.com/treatment/chiropractic/what-expect-first-chiropractic-consultation" target="_blank" rel="noreferrer noopener"
          >
          ...
          <a
            class="block rounded-xl border border-green-800 p-8 shadow-xl transition hover:border-green-500/10 hover:shadow-stone-500/10"
            href="https://www.chirohealthusa.com/consultants/when-should-re-examinations-be-performed/" target="_blank" rel="noreferrer noopener"
          >
  ...
  <path fillRule="evenodd" d="M3 9.375C3 8.339 3.84 7.5 4.875 7.5h9.75c1.036 0 1.875.84 1.875 1.875v11.25c0 1.035-.84 1.875-1.875 1.875h-9.75A1.875 1.875 0 013 20.625V9.375zm9.586 4.594a.75.75 0 00-1.172-.938l-2.476 3.096-.908-.907a.75.75 0 00-1.06 1.06l1.5 1.5a.75.75 0 001.116-.062l3-3.75z" clipRule="evenodd" />
          ...
          <a
            class="block rounded-xl border border-green-800 p-8 shadow-xl transition hover:border-green-500/10 hover:shadow-stone-500/10"
            href="https://www.mayoclinic.org/tests-procedures/chiropractic-adjustment/about/pac-20393513" target="_blank" rel="noreferrer noopener"
          >
